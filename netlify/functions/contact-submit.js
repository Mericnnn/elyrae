export const handler = async (event) => {
    ...
    const secretKey = "r4ad_Adm1n_contact_2025_secret!@#";
    ...
    try {
      ...
      const formspreeEndpoint = "https://formspree.io/f/mjkjvaqe";
      ...
      console.log("✅ Contact-aanvraag verstuurd via Formspree:", body);
      ...
      console.error("❌ Fout in contact-submit function:", error);
      return {
        statusCode: 500,
        headers,
